...
int main (int argc, char **argv)
{
    ...
    remoteDataHops = energyNetwork(mpiRanksNode, argv[2], &localData, &remoteData);
    ...
    cout<< "Percentage Local Communication:"<<PerLocalComm<<"%"<<endl;
    cout<< "Percentage Energy for Communication:"<<PerEnergyComm<<"%"<<endl;
    cout<< "Total Energy:"<<TotalEnergy<<"J"<<endl;
    cout<< "Average Total Power:"<<TotalPower<<"W"<<endl;
    cout<< "Average Power per Node:"<<AVGPowerNode<<"W"<<endl;
