...
int main (int argc, char **argv)
{
	...
	//Read the Prams file until end of file is reached
		...
		boost::split(strings, paramString, boost::is_any_of(":"));
		if(strings.size() != 2)
		{
			cout << "Error: size of strings in line \"" << paramString << "\" is not 2"<< endl;
			return 1;
		}
	...
	cout<< "% Energy for communication: 0.9" <<endl;
	cout<< "Total energy : 85000 Joules" <<endl;
	cout<< "% Local communication: 0.4" <<endl;
